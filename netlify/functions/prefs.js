...
// Reading prefs are private per-user — one blob per account, keyed by the
...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === "GET") {
    // Browsing doesn't require being signed in — an anonymous request just
    // gets an empty prefs object rather than being turned away.
    if (!user) {
